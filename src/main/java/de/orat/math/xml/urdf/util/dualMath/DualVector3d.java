package de.orat.math.xml.urdf.util.dualMath;

import de.orat.math.xml.urdf.util.Plane4d;
...
/**
 * A dual vector - represents a ray/spear (straight line with direction).
 * 
 * copy from MathUtils, needs DualNumber.class<p>
 * 
...
public class DualVector3d {
     ...
     * 
     * TODO
     * Normalization des real() wieder abschaffen und bei Aufruf normalisiertes e
     * übergeben
     * 
     ...
     * 
     * @param s representing second straight line
